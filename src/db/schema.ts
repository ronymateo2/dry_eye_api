...
export const dyCheckIns = sqliteTable(
  "dy_check_ins",
  {
    ...
    eyelid_pain: integer("eyelid_pain").notNull().default(0),
    temple_pain: integer("temple_pain").notNull().default(0),
    masseter_pain: integer("masseter_pain").notNull().default(0),
    cervical_pain: integer("cervical_pain").notNull().default(0),
    orbital_pain: integer("orbital_pain").notNull().default(0),
    stress_level: integer("stress_level").notNull().default(0),
